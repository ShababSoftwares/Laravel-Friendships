...
namespace ShababSoftwares\Friendships\Models;
...
/**
 * Class Friendship
 * @package ShababSoftwares\Friendships\Models
 */
class Friendship extends Model
{
    ...
    {
        return $this->morphTo('sender')->select('*')->isonline();
    }
    ...
    {
        return $this->morphTo('recipient')->select('*')->isonline();
    }
